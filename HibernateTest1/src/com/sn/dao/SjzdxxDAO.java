...
public class SjzdxxDAO extends BaseHibernateDAO {
	...
	public Sjzdxx findById(java.lang.Integer id) {
		...
		try {
			Sjzdxx instance = (Sjzdxx) getSession().get("com.sn.po.Sjzdxx", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Sjzdxx instance) {
		...
		try {
			List results = getSession().createCriteria("com.sn.po.Sjzdxx").add(
